  ...
  return (
    <>
      <div className='assignment-i'>
        <button className='btn bg-[#6884FD] shadow-[#6884FD] hover:drop-shadow-2xl'>
          Book Now 
        </button>
      ...
      <div className='assignment-ii'>
        <form action="" className='form'>
          ...
          <div className="flex">
            <hr className="w-full justify-center m-auto items-center border-[#625d5d]" />0<hr className="w-full justify-center m-auto items-center border-[#625d5d]"/>
          </div>
          ...
          <div className="flex">
            <hr className="w-full justify-center m-auto items-center border-[#625d5d]" />o<hr className="w-full justify-center m-auto items-center border-[#625d5d]"/>
          </div>
      ...
      <div className="assignment-iii">
        ...
        <div className="grid grid-cols-3 gap-8 m-6 p-16 bg-[gray] flex-wrap w-fit">
          <motion.div
            className="box"
                ...
                <div className="m-5">
                  ...
                  <div className="card">
                    ...
                    <button className='items-end  flex gap-2 border-2 border-black rounded-sm px-3 py-1'>
                      Connect 
                      <svg xmlns="http://www.w3.org/2000/svg" fill="fff" viewBox="0 0 24 24" strokeWidth={1.5} stroke="fff" className="w-4 h-6">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}          
          >
            <div className='bg-blur-lg w-fit h-full border-red-500 border-2 m-2'>
              <div className="blog-title">
                <div>
                  <img src="blog-bg.jpg" width={400} height={40}/>
                </div>
                <div className='flex m-5'>
                  <div className=''>
                    <img src="blog.jpeg" width={50} height={50} className='rounded-full border-2 border-white mt-[-35px]' />
                  </div>
                    <div className='flex items-center w-full justify-between'>
                      <div className='h-18'>
                        <h2 className='font-bold mx-5 text-black text-sm'>Priyanshu</h2>
                      ...
                      <div className='flex items-center'>
                        <div className="link w-14 h-14 rounded-md bg-[red] hover:cursor-pointer flex justify-center items-center">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="000" className="w-8 h-8">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                          </svg>
                        </div>
                      </div>
